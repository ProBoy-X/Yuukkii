...
STICKERS = (
    "CAACAgUAAx0CU7OPAwADC2C2S2hzpH-96hVBDxEAAUztDvMbMAACUQIAAqrAsVU8nmIoM5PdbR4E",
    "CAACAgUAAx0CU7OPAwADDmC2S3LQwRMydkrDqPbQ5VWA6kmuAAIYAwACeGawVTI2n--1UMEIHgQ",
    "CAACAgUAAx0CU7OPAwADEWC2S3kxOgZPkadhMXt9qJWCrQGEAALPAgACLUKxVZzrwV96R5mRHgQ",
    "CAACAgUAAx0CU7OPAwADFGC2S35lly7JrHcSmLdOoHGP8UUfAAIyAwAC8_6xVQ4VERGWhMqJHgQ",
    "CAACAgUAAx0CU7OPAwADF2C2S4HZkHuRHfZAUYOZQlsFZfjfAAKGAwACMfGwVb9FOh9TNRA9HgQ",
    "CAACAgUAAx0CU7OPAwADGmC2S4epUUR1HF47pnueasHdGVY2AALEAgAC2NO4VW5QPLKICy_-HgQ",
    "CAACAgUAAx0CU7OPAwADHWC2S4vSKqE5GQ04GpSHJNmKASrXAAJOAgACks6xVcfFrbdQp44PHgQ",
...
async def get_start_func(message, strings, edit=False):
    ...
    buttons.add(
        ...
        InlineKeyboardButton(
            strings["btn_source"], url="https://github.com/JassManak1125/"
        ),
    )
    buttons.add(
        InlineKeyboardButton(
    ...
    buttons.add(
        InlineKeyboardButton(
            "👸🏼 Add Yuki to your group",
            url=f"https://telegram.me/YuukiRoBot?startgroup=true",
        )
    )
...
async def help_cmd_g(message, strings):
    ...
    button = InlineKeyboardMarkup().add(
        InlineKeyboardButton(text=text, url="https://t.me/YuukiRoBot?start")
    )
    await message.reply(strings["help_header"], reply_markup=button)
