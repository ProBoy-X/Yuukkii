...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main Bot", url="https://t.me/YuukiRoBot"),
        InlineKeyboardButton("Go Inline!", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[Yuki✨](https://github.com/JassManak1125):**
**MainBot:** `{bot_state}`
**UserBot:** `Alive`
**Python:** `3.9`
**Pyrogram:** `{pyrover}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/Its_JassManak)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check Bot's Stats",
            thumb_url="https://telegra.ph/file/a778e5c96ca3bbe273111.jpg",
